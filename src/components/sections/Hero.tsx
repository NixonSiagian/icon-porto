...
export function Hero() {
  return (
    <section className="relative h-screen w-full flex items-center px-6 overflow-hidden">
        ...
        >
          <div className="space-y-4">
            ...
            <motion.h1 
              ...
              className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-[0.85] font-display text-white drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)] cursor-default transition-all duration-300 hover:text-workspace-highlight"
            >
              NIXON<br />
          ...
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 mt-4">
            <button 
              ...
              className="px-10 py-4 sm:py-5 bg-workspace-highlight text-black font-bold rounded-2xl hover:bg-white transition-all duration-300 text-sm uppercase tracking-wider shadow-2xl"
            >
              View Projects
            </button>
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="px-10 py-4 sm:py-5 bg-black/40 backdrop-blur-xl text-white font-bold rounded-2xl hover:bg-white/10 transition-all duration-500 border border-white/10 flex items-center justify-center gap-3 text-sm uppercase tracking-wider shadow-2xl"
            >
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce opacity-40 pointer-events-none z-30 transition-opacity hover:opacity-100">
        <ChevronDown size={32} className="text-white" />
      </div>

      {/* Subtle Visual Vignette for readability */}
